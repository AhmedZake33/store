...
export default {
  ...
  computed: {
    ...mapGetters({
      items: 'faculty_questionnaires/items',
      total: 'faculty_questionnaires/total',
      load: 'faculty_questionnaires/load',
      needDrop:'app/needDrop',
      lookups: 'faculty_questionnaires/lookups',
    }),
  },
  methods: {
    refresh(query) {
      query = { ...query, type: this.type };
      this.$store.dispatch('faculty_questionnaires/questionnaires', { query: query });
    },
  },
};
</script>
