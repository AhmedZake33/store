...
export default {
  ...
  methods: {
    ...
    refresh(query) {
      ...
      query.offering_id = this.offering_id_param;
      this.$store
        .dispatch("examsSchedules/examsSchedules", { query: query })
        .then((data) => {
    ...
    open(examId, id) {
      this.$router.push({
        ...
        query: { exam_id: examId, id: id, offering_id: this.offering_id_param },
