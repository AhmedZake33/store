...
export default function userCalendar() {
  ...
  const fetchEvents = (info, successCallback) => {
    ...
    store
    .dispatch('calendars/fetchEvents', { calendars: {types: selectedCalendars.value, time_type: selectedTimeType.value , date: info ? info.startStr.split('T')[0] : null }, id: routeParamsId , type: "course"})
    .then(response => {
