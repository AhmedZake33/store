            ...
            >
              <template v-slot:eventContent="arg">
                ...
                <b-tooltip
                  ...
                  :target="arg.event.id"
                  :variant=" 
                    arg.event.extendedProps.conflicts.location_conflicts.length > 0
                      ? 'danger'
                      : 'dark'
                  "
                >
                  <div class="info">
                    ...
                    >
                      {{
                        $i18n.locale == "ar"
                          ? "اسم المادة: " + arg.event.extendedProps.courseName
                          : "Course Name: " + arg.event.extendedProps.courseName
                      }}
                    </p>
                    <p
                      class="d-block m-0"
                      ...
                      >
                        {{
                          $i18n.locale == "ar"
                            ...
                            : "instructor: " + instructor.academic_name
                        }}
                      </span>
                    </p>
                  </div>
                  <div
                    ...
                    class="conflict-info"
                  >
                    <!-- <div v-if="arg.event.extendedProps.conflicts.instructor_conflicts">
                      <div
                        v-if="
                          arg.event.extendedProps.conflicts.instructor_conflicts.length > 0
                        "
                      >
                        <p
                          class="d-block m-0"
                          v-for="item in arg.event.extendedProps.conflicts.instructor_conflicts"
                          :key="item.id"
                        >
                    ...
                    >
                      ...
                      >
                        <p
                          class="d-block m-0"
                          v-for="item in arg.event.extendedProps.conflicts.location_conflicts"
                          :key="item.id"
                        >
                          {{ $i18n.locale == "ar" ? item.msg_ar : item.msg }}
                        </p>
