      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <statistic-card-horizontal
            icon="ClockIcon"
            color="warning"
            :statistic="items.tutorial_hours"
            :statistic-title="
              $i18n.locale == 'ar'
                ? 'إجمالي ساعات الدروس'
        ...
        <div class="col-md-3">
          <statistic-card-horizontal
            icon="ClockIcon"
            color="success"
            :statistic="items.laboratory_hours"
            :statistic-title="
        ...
        <div class="col-md-3">
          <statistic-card-horizontal
            icon="ClockIcon"
            :statistic="items.total_office_hours"
            color="secondary"
            :statistic-title="
              $i18n.locale == 'ar' ? 'إجمالي ساعات العمل' : 'Total Office Hours'
            "
          />
        </div>
      </div>
