          ...
          <div>
            <table>
              ...
              <tr>
                ...
                <td>
                  <span v-if="data.payment_setting.level">
                    {{ getTranslatedNameFromObject(data.payment_setting.level) }}
                  </span>
                </td>
              </tr>
            </table>
            ...
            >
              ...
              <tbody style="text-align: initial">
                <tr>
                  ...
                  <td>
                    {{ data.payment_installments.length ? data.payment_installments[0].value_local : data.payment_setting.value_local }}
                  </td>
                  <td>
                    {{ data.payment_installments.length ? data.payment_installments[0].value_usd : data.payment_setting.value_usd }}
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    {{ data.payment_installments.length ? data.payment_installments[1].value_local : data.payment_setting.value_local }}
                  </td>
                  <td>
                    {{ data.payment_installments.length ? data.payment_installments[1].value_usd : data.payment_setting.value_usd }}
                  </td>
                </tr>
              </tbody>
              <tfoot>
