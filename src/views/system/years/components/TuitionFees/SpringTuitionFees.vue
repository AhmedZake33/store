<template>
    <b-card no-body>
      ...
      <div class="all-modals">
        ...
        >
          <div>
           <edit-spring-tuition-fees-level
              v-if="edit"
              :data="level_item"
              :yearId="yearId"
            ...
            <show-spring-tuition-fees-level
              v-else
              :data="level_item"
              :yearId="yearId"
              :paymentSettingId="paymentSettingId"
      ...
      >
        ...
        <b-modal
          ...
          @hidden="resetModal"
        >
          <edit-spring-custom-program-fees
  ...
  import ShowSpringTuitionFeesLevel from "./ShowSpringTuitionFeesLevel";
  import EditTuitionFeesLevel from "./EditTuitionFeesLevel";
  import EditSpringTuitionFeesLevel from "./EditSpringTuitionFeesLevel";
  ...
  import EditSpringCustomProgramFees from "./CustomPrograms/EditSpringCustomProgramFees";
  ...
  export default {
    components: {
      ...
      EditSpringCustomProgramFees,
      EditExtraCreditHourFees,
      ShowExtraCreditHourFees,
      ShowSpringTuitionFeesLevel,
      EditSummerHourFees,
      ShowSummerHourFees,
      BFormGroup,
      BFormInput,
    ...
    props: {
      ...
      tuitionType: {
        default: "spring-tuition-fees-ug",
        type: String,
      },
    },
    data() {
    ...
    methods: {
      ...
      init() {
        ...
        this.getTuitionFees({ yearId: this.yearId, type: this.tuitionType })
          .then((response) => {
            if (this.tuitionType === "spring-tuition-fees-ug") {
      ...
      addCustomProgramFeesModal(facultyId) {
        ...
        this.paymentSettingId =
          this.tuitionType == "spring-tuition-fees-ug"
            ? "create-spring-custom-program-fees-ug"
            : "create-spring-custom-program-fees-pg";
