            ...
            >
              <template #custom_show>
                <tr>
                  ...
                  <td>
                    <span v-if="data.payment_setting.options_value">
                      {{ maxCredit ? data.payment_setting.options_value.max_credit_hours : data.payment_setting.options_value.min_credit_hours }}
                    </span>
                  </td>
                </tr>
              </template>
