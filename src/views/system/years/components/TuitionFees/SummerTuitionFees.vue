<template>
  <b-card no-body>
    ...
    <div class="all-modals">
      ...
      >
        <div>
         <edit-summer-tuition-fees-level
            v-if="edit"
            :data="level_item"
            :yearId="yearId"
          ...
          <show-summer-tuition-fees-level
            v-else
            :data="level_item"
            :yearId="yearId"
            :paymentSettingId="paymentSettingId"
    ...
    >
      ...
      <b-modal
        ...
        @hidden="resetModal"
      >
        <edit-summer-custom-program-fees
...
import ShowSummerTuitionFeesLevel from "./ShowSummerTuitionFeesLevel";
import EditTuitionFeesLevel from "./EditTuitionFeesLevel";
import EditSummerTuitionFeesLevel from "./EditSummerTuitionFeesLevel";
...
import EditSummerCustomProgramFees from "./CustomPrograms/EditSummerCustomProgramFees";
...
export default {
  components: {
    ...
    EditSummerCustomProgramFees,
    EditExtraCreditHourFees,
    ShowExtraCreditHourFees,
    ShowSummerTuitionFeesLevel,
    EditSummerHourFees,
    ShowSummerHourFees,
    BFormGroup,
    BFormInput,
  ...
  props: {
    ...
    tuitionType: {
      default: "summer-tuition-fees-ug",
      type: String,
    },
  },
  data() {
  ...
  methods: {
    ...
    init() {
      ...
      this.getTuitionFees({ yearId: this.yearId, type: this.tuitionType })
        .then((response) => {
          if (this.tuitionType === "summer-tuition-fees-ug") {
    ...
    addCustomProgramFeesModal(facultyId) {
      ...
      this.paymentSettingId =
        this.tuitionType == "summer-tuition-fees-ug"
          ? "create-summer-custom-program-fees-ug"
          : "create-summer-custom-program-fees-pg";
