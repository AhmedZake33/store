          ...
          >
            ...
            >
              ...
              <template #cell(actions)="data">
                <div>
                  <feather-icon
                    v-if="hasPermission('show_services_fees')"
                  ...
                  />
                  <feather-icon
                    v-if="hasPermission('edit_services_fees')"
                  ...
                  />
                  <feather-icon
                    v-if="hasPermission('delete_services_fees')"
...
export default {
  ...
  methods: {
    ...
    addNewFeesModal() {
      this.feesData = null
      this.paymentSettingId = 'create-service-fees'

      this.modal_change_title = this.$t('Add New Service Fees')
      this.editFees = true
      this.modal_loading = false
