      ...
      >
        <b-col cols="12">
          <b-overlay
            ...
            rounded="sm"
          >
            <b-card v-if="data && formPaymentSetting">
              <b-card-header class="mt-0 pt-0 pb-0 p-0">
                <div class="mt-0 d-flex align-items-center">
                  <h3>
                    {{ $t('Edit Admission File Fees') }}
                  </h3>
                </div>
                <div class="mb-2">
                  <feather-icon
              ...
              <div>
                <b-col md="12">
                  ...
                  >
                    ...
                    >
                      <v-select
                        v-model="formPaymentSetting.options.after"
  ...
  methods: {
    ...
    init() {
      this.formPaymentSetting = {
        options: {
          after: this.data.options_value.after,
        },
        value_local: this.data.value_local,
        value_usd: this.data.value_usd,
      }

      this.data.payment_accounts.forEach((item, index) => {
