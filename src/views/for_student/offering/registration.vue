<template>
  <div v-if="studyingStudentStatus">
    <b-row>
      <SelectedOfferings @refreshSelector="refreshSelector" @checkStudentStudyingStatus="checkStudentStudyingStatus" ref="selectedOfferingsRef"></SelectedOfferings>
      <b-overlay class="col-12" rounded="sm">
        <Calendar class="mt-1 mx-1" ref="offeringSchedulesRef" :handleEvents="false"></Calendar>
      </b-overlay>
      <OfferingsSelector :studentId="studentId" :termId="updatedTermId" @refreshSelected="refreshSelected" ref="offeringSelectorsRef"></OfferingsSelector>
         ...
         <b-card
            ...
            <div>
              <!-- <simple-table
                  ...
                  :items="takenCourses.CoursesAtall"
                  :load="loading"
                >
                </simple-table> -->
                <template>
            ...
            <div>
              <!-- <TabTable
                ...
                :inner="[
                  ...
                  { key: 'credit_points', label: this.$t('Global.credit_points'),thStyle: { width: '10%' }, },
                  { key: 'grade_type', label: this.$t('Global.grade_type'),thStyle: { width: '10%' }, },
                ]"
              /> -->
...
import SelectedOfferings from "@/views/for_student/offering/components/SelectedOfferings.vue";
import OfferingsSelector from "@/views/for_student/offering/components/OfferingsSelector.vue";
...
export default {
  ...
  methods: {
    ...
    refreshSelected(){
      this.$refs.selectedOfferingsRef.updateTables(false);
