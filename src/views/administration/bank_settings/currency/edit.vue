<template>
  ...
  export default {
    ...
    computed: {
      ...
      title() {
        return this.id
          ? this.$t("Global.Edit Currency")
          : this.$t("Global.Add Currency");
      },
    },
    data() {
      return {
      ...
      init() {
        if (this.id) {
          this.getItem(this.id).then((data) => {
            ...
            this.form.name_local = data.data.name_local;
      ...
      save() {
        this.$refs.simpleRules.validate().then((success) => {
          if (success) {
            ...
            this.$store
              .dispatch("currencies/put", payload)
              .then((response) => {
                this.$swal({
                  icon: "success",
                ...
                // this.$router.push({ name: "bank_settings" });
                this.$router.push({
                  name: "bank_settings",
