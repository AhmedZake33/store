                ...
                <div>
                    <b-button
                        v-if="hasPermission('edit_offering')"
                            ...
                            variant="primary"
                            class="btn-icon"
                            @click="params = { status: 4, faculty_id: faculty_id, 
                            bylaw_id: bylaw_id }; addClicked()"
                    >
...
<script>
    ...
    import Add from '@/views/study/offerings/components/add_instructors';
