import bank from '../../../../api/administration/banks/bank';
...
const BankModule = {
    ...
    actions: {
        banks({commit}, payload) {
            return new Promise((resolve, reject) => {
                commit('SET_ITEMS_LOAD', true);
                banks.list(payload.query)
                    .then(response => {
        ...
        put({commit}, payload) {
            commit('SET_ITEMS_LOAD', true);
            return new Promise((resolve, reject) => {
                banks.put(payload.id, payload.query)
                    .then(response => {
                        commit('SET_ITEMS_LOAD', false);
                        resolve(response);
                    })
